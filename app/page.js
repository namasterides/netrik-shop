...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 overflow-x-hidden selection:bg-emerald-200/60 selection:text-emerald-900">
      ...
      >
        <div className="max-w-7xl mx-auto px-5 md:px-8 h-[9.5rem] md:h-[10.5rem] flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            <NetrikLogo variant="primary" className="h-[9rem] md:h-[10rem] w-auto max-w-[740px] md:max-w-[860px]" />
          </Link>
      ...
      {/* ───────── HERO ───────── */}
      <section className="relative pt-40 md:pt-52 pb-20 md:pb-28 px-5 md:px-8">
      ...
      <footer className="border-t border-neutral-200/80 py-10 px-5 md:px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-5 text-sm text-neutral-500">
          <div className="flex items-center gap-3">
            <NetrikLogo variant="primary" className="h-[5.25rem] md:h-24 w-auto max-w-[480px] md:max-w-[570px]" />
